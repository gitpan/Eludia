...
A.lnk15 {
	FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: #909090; FONT-FAMILY: Arial; TEXT-DECORATION: none
}
A.lnk15:link {
	FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: #909090; FONT-FAMILY: Arial; TEXT-DECORATION: none
}
...
div.table-container {
      	...
      	PADDING-BOTTOM: 0px;
      	MARGIN: 0px;
      	WIDTH: expression(document.body.offsetWidth - (window.name == 'application_frame' ? 12 : 17));
      	PADDING-TOP: 0px;      	
