...
<HEAD>
	...
	<SCRIPT LANGUAGE="JavaScript" FOR="ColorTable" EVENT="onclick">
	  window.returnValue = event.srcElement.style.background;
	  window.close ();  
	</SCRIPT>
...
<BODY BGCOLOR="#FFFFFF" TEXT="#000000" LINK="#FF0000" VLINK="#800000" ALINK="#FF00FF" BACKGROUND="?">
	<table id="ColorTable" border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
		<tr>
			...
			<td style="background:336600"></td>
			<td style="background:339900"></td>
			<td style="background:33CC00"></td>
			<td style="background:33FF00"></td>
		...
		<tr>
			...
			<td style="background:00CC66"></td>
			<td style="background:00FF66"></td>
			<td style="background:330066"></td>
			<td style="background:333366"></td>
			<td style="background:336666"></td>
			<td style="background:339966"></td>
			<td style="background:33CC66"></td>
			<td style="background:33FF66"></td>
			<td style="background:660066"></td>
			<td style="background:663366"></td>
		...
		<tr>
			...
			<td style="background:330099"></td>
			<td style="background:333399"></td>
			<td style="background:336699"></td>
			<td style="background:339999"></td>
		...
		<tr>
			...
			<td style="background:996666"></td>
			<td style="background:999966"></td>
			<td style="background:99CC66"></td>
			<td style="background:99FF66"></td>
			<td style="background:CC0066"></td>
			<td style="background:CC3366"></td>
		...
		<tr>
			...
			<td style="background:9933CC"></td>
			<td style="background:9966CC"></td>
			<td style="background:9999CC"></td>
			<td style="background:99CCCC"></td>
